...
const COURSES = {
  ...
  2: {
    ...
    shortName: "ACRONYM2",
    scriptUrl: "https://script.google.com/macros/s/AKfycbxm4aKaYw6N_dh7K-ZaPvMQIKEflsAlcQhghwSsaRN7Jn4GPt4-gVz-SWzFN95nmsCv/exec",
  },
  ...
  3: {
    ...
    shortName: "ACRONYM2",
    scriptUrl: "https://script.google.com/macros/s/AKfycbxgjhbCH9h9Fe7G0liqBFIWyM_hV6TgUC5XbYVTcgHwSZEck8s4MpCZ6SqsqWDRt6U/exec",
  },
  4: {
    id: 4,
    name: "Automate, calculabilitate si complexitate",
    shortName: "ACRONYM2",
    scriptUrl: "https://script.google.com/macros/s/AKfycbzBKH1TOQglJk2GwLWrJqyc-kw8wZYdTfHIBe2v-hpCzGJcgklkqvTPLUaVxzgkra7FLQ/exec",
  },
   5: {
    id: 5,
    name: "Sisteme de gestiune a bazelor de date",
    shortName: "ACRONYM2",
    scriptUrl: "https://script.google.com/macros/s/AKfycbyZ8S1pqrQ81k5Usf2JhEASzK0qCJPwF3j4IWXgugJ5ijDHLnuXwGs4hJ64IwsGl4o/exec",
  },
};

// Campus location for geolocation check
const CAMPUS = {
  lat: 46.198582099764764,
